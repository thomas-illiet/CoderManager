...
class Settings(BaseSettings):
    ...
    cyberark_emea_development_region: str | None = None
    ...
    cyberark_emea_staging_region: str | None = None
    ...
    cyberark_emea_production_region: str | None = None
    ...
    cyberark_apac_development_region: str | None = None
    ...
    cyberark_apac_staging_region: str | None = None
    ...
    cyberark_apac_production_region: str | None = None
    ...
    cyberark_amer_development_region: str | None = None
    ...
    cyberark_amer_staging_region: str | None = None
    ...
    cyberark_amer_production_region: str | None = None
